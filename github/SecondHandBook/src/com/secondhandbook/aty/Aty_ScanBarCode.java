...
import com.secondhandbook.zxing.CameraManager;
import com.secondhandbook.zxing.CaptureActivityHandler;
import com.secondhandbook.zxing.InactivityTimer;
import com.secondhandbook.zxing.LightControl;
import com.secondhandbook.zxing.ViewfinderView;

/**
 * Initial the camera
 * @author Ryan.Tang
 */
public class Aty_ScanBarCode extends Activity implements Callback {
	...
	public void handleDecode(Result result, Bitmap barcode) {
		...
		if (resultString.equals("")) {
			Toast.makeText(Aty_ScanBarCode.this, "Scan failed!", Toast.LENGTH_SHORT).show();
		}else {
